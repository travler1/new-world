...
public class ImageController {
    ...
    @ResponseBody
    public Map<String, String> processProfile(@LoginAccount Member member,
        ...
        //로그인한 회원 조회
         if (member == null) {
            ...
            if (member.getProfileImage() != null) {
                ...
                fileStore.deleteFile(member.getProfileImage(), FileCategory.PROFILE_IMAGE);
                memberRepository.deleteProfileById(member.getId(), member.getProfileImage());
            }
            //파일 저장
            ...
            memberRepository.updateProfileById(member.getId(), member.getProfileImage());
            memberRepository.updateUploadFileById(member.getId(), uploadFile);
