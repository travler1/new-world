...
public class SaveEmpForm {
    ...
    public EmpInfo toEntity(Member member, UploadFile uploadFile) {

        EmpInfo empInfo = EmpInfo.builder()
                .comSize(comSize)
                .comPeople(comPeople)
                .field(field)
                .role(role)
                ...
                .location_api_lat(location_api_lat)
                .location_api_lng(location_api_lng)
                .workStart(workStart)
                .advice(advice)
