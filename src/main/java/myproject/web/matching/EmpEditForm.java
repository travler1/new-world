...
public class EmpEditForm {
    ...
    @Builder
    public EmpEditForm(Long id, String comSize, String comPeople, String field, String role, String career, String salary_status, String salary, String periodTime, String education, String major, String certification, String location, String location_api, String location_api_lat, String location_api_lng, String workStart, MultipartFile multipartFile, String advice, UploadFile uploadFile, EmbeddedDate date, Member member) {
        this.id = id;
