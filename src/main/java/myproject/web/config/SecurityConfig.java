...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeHttpRequests(authorize -> authorize.requestMatchers("/").authenticated() //인증만 되면 들어갈 수 있는 주소
                ...
                .formLogin(formLogin -> formLogin.loginPage("/loginForm").permitAll()
                        ...
                        .defaultSuccessUrl("/")); // 로그인 성공 시 기본적으로 리디렉션되는 URL을 "/"로 설정
        ...
        //      .userInfoEndpoint(userInfoEndpoint -> userInfoEndpoint.userService(null)));
